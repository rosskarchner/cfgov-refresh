...
class TestCalendarEvents(TestCase):
    ...
    def test_display_calls_pdf_response(self, mock_PDFreactor, mock_set_cal_events_context, mock_pdf_response, mock_form_class, mock_render):
        mock_form = mock.Mock()
    ...
    @mock.patch('cal.views.pdf_response')
    @mock.patch('cal.views.set_cal_events_context')
    def test_display_calls_render_for_print(self, mock_set_cal_events_context, mock_pdf_response, mock_form_class, mock_render):
        mock_form = mock.Mock()
        mock_form.is_valid.return_value = True
        mock_form_class.return_value = mock_form
    ...
    @mock.patch('cal.views.set_cal_events_context')
    def test_display_calls_set_pagination_context(self, mock_set_cal_events_context, mock_set_pagination_context, mock_form_class, mock_render):
        mock_form = mock.Mock()
        mock_form.is_valid.return_value = True
        mock_form_class.return_value = mock_form
        display(self.request)
    ...
    @mock.patch('cal.views.set_pagination_context')
    @mock.patch('cal.views.set_cal_events_context')
    def test_display_calls_render_for_regular_view(self, mock_set_cal_events_context, mock_set_pagination_context, mock_form_class, mock_render):
        mock_form = mock.Mock()
        mock_form.is_valid.return_value = True
        mock_form_class.return_value = mock_form
...
class TestSetPaginationContext(TestCase):
    ...
    def test_calls_configure_page_days(self, mock_configure_page_days, mock_paginator):
...
class TestPDFResponse(TestCase):
    ...
    @mock.patch('cal.views.PDFreactor')
    def test_returns_http_response(self, mock_pdf_reactor, mock_get_template, mock_render):
    ...
    @mock.patch('cal.views.get_template')
    @mock.patch('cal.views.PDFreactor')
    def test_calls_render(self, mock_pdf_reactor, mock_get_template, mock_HttpResponse, mock_render):
