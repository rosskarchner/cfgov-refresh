...
class TestShareThePage(TestCase):
    ...
    def test_save_draft(self, mock_flush_akamai, mock_configure_page_revision, mock_share, mock_check_permissions):
        """
    ...
    @mock.patch('v1.wagtail_hooks.configure_page_revision')
    @mock.patch('v1.wagtail_hooks.flush_akamai')
    def test_share_on_content(self, mock_flush_akamai, mock_configure_page_revision, mock_share, mock_check_permissions):
        """
    ...
    @mock.patch('v1.wagtail_hooks.configure_page_revision')
    @mock.patch('v1.wagtail_hooks.flush_akamai')
    def test_publish_to_www(self, mock_flush_akamai, mock_configure_page_revision, mock_share, mock_check_permissions):
        """
    ...
    @mock.patch('v1.wagtail_hooks.configure_page_revision')
    @mock.patch('v1.wagtail_hooks.flush_akamai')
    def test_function_calls(self, mock_flush_akamai, mock_configure_page_revision, mock_share, mock_check_permissions):
        """
